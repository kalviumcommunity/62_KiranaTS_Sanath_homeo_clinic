...
export default function KammanahalliPage() {
    return (
            ...
            <nav className="fixed top-0 left-0 w-full z-50 p-4 flex items-center shadow-2xl bg-[#E8E669]" style={{ height: "100px" }}>
                ...
                <div className="flex w-full items-center justify-center gap-3">
                    <span className="text-2xl md:text-3xl font-bold text-black text-center" style={{ fontFamily: 'Merriweather' }}>
                        SANATH HOMEO CLINIC - Kammanahalli
                    </span>
                </div>
            </nav>

            {/* Page Content - Now with Contact FIRST */}
            <div className="flex flex-col items-center justify-center pt-32 pb-20 px-4 md:px-8 gap-12 text-black">
                ...
                <section className="w-full max-w-5xl text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-[#E8E669]/20 p-4 rounded-lg">
                                ...
                                <div className="space-y-2">
                                    <p><b>📞:</b> 096111 09900</p>
                                    <p><b>✉️:</b> kammanahalli@sanathhomeoclinic.com</p>
                                    <p><b>🕙:</b> 10AM-2PM, 5PM-9PM (Closed Sun)</p>
                                    <a
                                        href="https://www.google.com/maps/dir//Nehru+Main+Road,+Nxt+to+Canara+Bank+Kammanahalli,+beside+Canara+Bank,+Kacharakanahalli,+Branch,+Bengaluru,+Karnataka+560084"
                                        target="_blank"
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-5 mb-10">
                        <img
                            src="/images/Kammanahalli.png"
                            alt="Kammanahalli Clinic"
                ...
                <section className="w-full max-w-5xl bg-white rounded-xl shadow-lg p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                        {[
                            "Autoimmune disease","Skin Disease Treatment", "Gall Bladder (Biliary) Stone Treatment", "Kidney Stone Treatment",
                            "Weight Loss Diet Counseling", "Liver Disease Treatment", "Arthritis Management", "Hair Loss Treatment",
                            "Dandruff Treatment", "Allergy Treatment", "Diabetes Management", "Irritable Bowel Syndrome",
                            "Obesity Treatment", "Bronchial Asthma Treatment", "Infertility Evaluation / Treatment", "Acidity Treatment",
                            "Bronchitis Treatment", "Cervical Spondylitis Treatment", "Cysts", "Depression Treatment", "Dermatitis Treatment",
                            "Eczema Treatment", "Insomnia Treatment", "Dysmenorrhea Treatment", "Piles Treatment (Non Surgical)",
                            "Migraine Treatment", "Psoriasis Treatment", "Rheumatism Treatment",
                            "Thyroid Disorder Treatment", "Vertigo Treatment", "Warts", "Lifestyle Disorders Treatment",
                            "PCOD/PCOS Treatment", "Skin Disorder", "Rheumatic Complaints", "Acne / Pimples Treatment",
                            "Sinusitis", "Colitis Treatment", "Gastritis Treatment",
                            "Vaccination/ Immunization", "Hypertension Treatment"
                        ].map((item, index) => (
